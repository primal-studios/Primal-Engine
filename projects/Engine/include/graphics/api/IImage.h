...
enum EMemoryPropertyBits : uint32_t
{
...
enum EAllocationCreationBits : uint32_t
{
	ALLOCATION_CREATE_DEDICATED_MEMORY = 0x00000001,
	ALLOCATION_CREATE_NEVER_ALLOCATE = 0x00000002,
	ALLOCATION_CREATE_MAPPED = 0x00000004,
	ALLOCATION_CREATE_CAN_BECOME_LOST = 0x00000008,
	ALLOCATION_CREATE_CAN_MAKE_OTHER_LOST = 0x00000010,
	ALLOCATION_CREATE_USER_DATA_COPY_STRING = 0x00000020,
	ALLOCATION_CREATE_UPPER_ADDRESS = 0x00000040,
	ALLOCATION_CREATE_STRATEGY_BEST_FIT = 0x00010000,
	ALLOCATION_CREATE_STRATEGY_WORST_FIT = 0x00020000,
	ALLOCATION_CREATE_STRATEGY_FIRST_FIT = 0x00040000,
	ALLOCATION_CREATE_STRATEGY_MIN_MEMORY = ALLOCATION_CREATE_STRATEGY_BEST_FIT,
	ALLOCATION_CREATE_STRATEGY_MIN_TIME = ALLOCATION_CREATE_STRATEGY_FIRST_FIT,
	ALLOCATION_CREATE_STRATEGY_MIN_FRAGMENTATION = ALLOCATION_CREATE_STRATEGY_WORST_FIT,
	ALLOCATION_CREATE_STRATEGY_MASK =
	ALLOCATION_CREATE_STRATEGY_BEST_FIT |
	ALLOCATION_CREATE_STRATEGY_WORST_FIT |
	ALLOCATION_CREATE_STRATEGY_FIRST_FIT,
};

using AllocationCreationFlags = uint32_t;
...
struct ImageCreateInfo
{
	...
	MemoryPropertyFlags memoryRequiredFlags;
	MemoryPropertyFlags memoryPreferredFlags;
	AllocationCreationFlags memoryAllocationFlags;
};
